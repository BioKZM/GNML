...
import 'package:gnml/UI/Games/data/games_page_data.dart';
              ...
              children: [
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      if (pageIndex.value > 1) {
                        pageControllerMostlyAnticipated.jumpToPage(1);
                        pageIndex.value = 1;
                        // setState(() =>
                        //     pageIndex.value =
                        //         1);
                ...
                Padding(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      if (pageIndex.value < totalPages) {
                        pageControllerMostlyAnticipated.jumpToPage(totalPages);
